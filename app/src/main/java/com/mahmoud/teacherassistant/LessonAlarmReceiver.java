...
public class LessonAlarmReceiver extends BroadcastReceiver {
    ...
    public void onReceive(
        ...
        // Do not call scheduleAll() here.
        // The scheduler already created the next weekly alarm when
        // the lesson/group was saved. Calling scheduleAll() from the
        // receiver can recreate the current reminder and cause repeats.
    }
}
