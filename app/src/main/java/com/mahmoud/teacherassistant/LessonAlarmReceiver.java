...
public class LessonAlarmReceiver extends BroadcastReceiver {
    ...
    public static final String EXTRA_NOTIFY_MINUTES = "notify_minutes";
    ...
    public void onReceive(
        ...
        // Schedule only the next occurrence of THIS reminder.
        try {
            String day =
            ...
            int notifyMinutes =
                    intent.getIntExtra(
                            EXTRA_NOTIFY_MINUTES,
                            15
                    );

            NotificationScheduler.scheduleNextWeekly(
                    context,
                    lessonId,
                    group,
                    place,
            ...
            Log.e(
                    TAG,
                    "Failed to schedule next weekly occurrence",
                    e
            );
        }
    }
