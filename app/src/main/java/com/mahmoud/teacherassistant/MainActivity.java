    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(
                ...
                if (url.toLowerCase().contains("chat.whatsapp.com/")) {
                    openWhatsAppGroupChooser(url);
                    return true;
                }
            ...
            public boolean shouldOverrideUrlLoading(
                ...
                if (url != null &&
                        url.toLowerCase().contains("chat.whatsapp.com/")) {
                    openWhatsAppGroupChooser(url);
                    return true;
                }
        ...
        public void sendGroupMessage(String message) {
            ...
            runOnUiThread(() -> {
                try {
                    ...
                    chooserBase.putExtra(Intent.EXTRA_TEXT, message);
                    ...
                    wab.putExtra(Intent.EXTRA_TEXT, message);
                    ...
                    if (hasWa && hasWab) {
                        ...
                        startActivity(wab);
                    } else if (send.resolveActivity(pm) != null) {
                        startActivity(Intent.createChooser(chooserBase, "اختار تطبيق لإرسال الرسالة"));
                    } else {
                        Log.w(TAG, "No app available to share WhatsApp group message");
                    }
                } catch (Exception e) {
                    Log.e(TAG, "Could not send group message", e);
                }
            });
        }
    }

    private void openWhatsAppGroupChooser(String url) {
