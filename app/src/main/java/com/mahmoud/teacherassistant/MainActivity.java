...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.setWebChromeClient(new WebChromeClient() {
            ...
            public boolean onCreateWindow(
                ...
                // Catch links opened with target="_blank" and send them through
                // the same external-link/WhatsApp chooser logic.
                ...
                popup.setWebViewClient(new WebViewClient() {
                    ...
                    public boolean shouldOverrideUrlLoading(WebView popupView, WebResourceRequest request) {
                        ...
                        boolean handled = openExternalIfNeeded(u);
                        popup.destroy();
                        return handled;
                    }
                    ...
                    public boolean shouldOverrideUrlLoading(WebView popupView, String url) {
                        boolean handled = openExternalIfNeeded(url);
                        popup.destroy();
                        return handled;
                    }
                });
    ...
    private boolean openExternalIfNeeded(String url) {
        ...
        try {
            ...
            // For WhatsApp links, show Android's app chooser so the user
            // can choose between WhatsApp and WhatsApp Business.
